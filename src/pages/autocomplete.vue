<template>
  <f7-page @page:beforeremove="onPageBeforeRemove" @page:init="onPageInit">
      ...
      <div class="subnavbar">
        <form class="searchbar" id="searchbar-autocomplete">
          <div class="searchbar-inner">
            ...
            <span class="searchbar-disable-button" v-if="!$theme.aurora"
              >Cancel</span
            >
          </div>
        </form>
    ...
    <div class="block">
      <p>
        Standalone autocomplete provides better mobile UX by opening it in a new
        page or popup. Good to use when you need to get strict values without
        allowing free-type values.
      </p>
    </div>
    <div class="list">
