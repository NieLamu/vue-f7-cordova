  ...
  <f7-page>
    ...
    <f7-list simple-list>
      <f7-list-item>
        <f7-list-item-cell class="width-auto flex-shrink-0">
          <f7-icon
            ios="f7:volume_mute_fill"
            aurora="f7:volume_mute_fill"
    ...
    <f7-list simple-list>
      <f7-list-item>
        <f7-list-item-cell class="width-auto flex-shrink-0">
          <f7-icon
            ios="f7:money_dollar_round"
            aurora="f7:money_dollar_round"
        ...
        <f7-list-item-cell class="width-auto flex-shrink-0">
          <f7-icon
            ios="f7:money_dollar_round_fill"
            aurora="f7:money_dollar_round_fill"
