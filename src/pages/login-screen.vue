<template>
  <f7-page>
    ...
    <f7-block>
      <p>
        Framework7 comes with ready to use Login Screen layout. It could be used
        inside of page or inside of popup (Embedded) or as a standalone overlay:
      </p>
    </f7-block>
...
<script>
import { f7Navbar, f7Page, f7LoginScreen, f7List, f7ListItem, f7Block, f7Button, f7LoginScreenTitle, f7BlockFooter, f7ListButton, f7ListInput } from 'framework7-vue'
