<template>
  <f7-page>
    ...
    <f7-block>
      <p>
        In addition to usual <a href="/cards/">Cards</a> there are also
        Expandable Cards that allow to store more information and illustrations
        ...
        <f7-card-content :padding="false">
          ...
          <div class="card-content-padding">
            ...
            <p>
              ...
              to create iOS and Android (Material) apps with HTML, CSS and
              JavaScript easily and clear. Framework7 is full of freedom. It
              doesn't limit your imagination or offer ways of any solutions
            ...
            <p>
              ...
              Android hybrid app (Cordova or PhoneGap) or web app that looks
      ...
      <f7-card expandable>
        <f7-card-content :padding="false">
          <div
            :style="{
              background:
                'url(../assets/img/beach.jpg) no-repeat center bottom',
