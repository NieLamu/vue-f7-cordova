<template>
  <f7-page>
    ...
    <f7-block strong>
      <p>
        Skeleton (or Ghost) elements designed to improve perceived performance
        and make app feels faster.
      </p>
      <p>
        Framework7 comes with two types of such elements: Skeleton Block and
        Skeleton Text. Skeleton block is a gray box that can be used as
        placeholder for any element. Skeleton text uses special built-in
        skeleton font to render each character of such text as gray rectangle.
        Skeleton text allows to make such elements responsive and feel more
        natural.
      </p>
    ...
    <f7-block strong>
      ...
      <f7-row tag="p">
        <f7-button fill small round class="col" @click="load('fade')"
          >Fade</f7-button
        >
        <f7-button fill small round class="col" @click="load('blink')"
          >Blink</f7-button
        >
        <f7-button fill small round class="col" @click="load('pulse')"
          >Pulse</f7-button
        >
      </f7-row>
    </f7-block>
