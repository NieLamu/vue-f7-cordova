<template>
  <f7-page @page:afterin="onPageAfterIn">
    ...
    <f7-block strong>
      <p>
        Menu component is designed to be used as overlay control. It can be very
        helpful when you need controls on top of the map, images, some text/code
        editor, etc.
      </p>
    </f7-block>
    ...
    <f7-block strong class="no-padding-horizontal" style="z-index: 2000">
      <p class="padding-horizontal">
        Dropdown can be position on left, center or right of the menu item. It
        also can be scrollable.
      </p>
      <f7-menu>
...
export default {
  ...
  methods: {
    ...
    initMap: function () {
      var self = this
      var mymap = window.L.map(self.$refs.map, { zoomControl: false }).setView([51.505, -0.09], 10)
      window.L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoibm9saW1pdHM0d2ViIiwiYSI6ImNqcXA4NTdmczBocm8zeG13Zm1zNTdyeDAifQ.HoJgmqQ_uH4zLyNJmiY98A', {
        maxZoom: 18,
