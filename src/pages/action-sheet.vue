  ...
  <f7-page @page:beforeremove="onPageBeforeRemove">
    ...
    <f7-block strong>
      <p class="row">
        ...
        <f7-button class="col" fill @click="$refs.actionsOneGroup.open()"
          >One group</f7-button
        >
        <!-- Two groups, open by "actions-open" attribute -->
        <f7-button class="col" fill actions-open="#actions-two-groups"
...
<script>
import { f7Navbar, f7Page, f7BlockTitle, f7Block, f7Button, f7Actions, f7ActionsGroup, f7ActionsLabel, f7ActionsButton } from 'framework7-vue'
