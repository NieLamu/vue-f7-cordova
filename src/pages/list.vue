  ...
  <f7-page>
    ...
    <f7-block>
      <p>
        ...
        can make them as navigation menus, you can use there icons, inputs, and
        any elements inside of the list, and even make them nested:
      </p>
    </f7-block>
...
<script>
import { f7Navbar, f7Page, f7BlockTitle, f7Block, f7List, f7ListItem, f7ListGroup, f7BlockFooter, f7Icon, f7Toggle } from 'framework7-vue'
